# python graphSAGE-compile.py reddit
# python graphSAGE-compile.py reddit compile
...
print(f'Running GraphSAGE-{agr_mode}-MP, Epoch: {EPOCH_COUNT}, Embedding: {EMBEDDING_SIZE}, Dataset: {sys.argv[1]}, Compile Mode: {compile_mode}')
...
class Net(torch.nn.Module):
    def __init__(self):
        ...
        self.conv1 = SAGEConv(dataset.num_node_features_, EMBEDDING_SIZE, cached=True, aggr=agr_mode)
        self.conv2 = SAGEConv(EMBEDDING_SIZE, dataset.num_classes_, cached=True, aggr=agr_mode)
