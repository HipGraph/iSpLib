...
print(f'Running GIN-MP, Epoch: {EPOCH_COUNT}, Embedding: {EMBEDDING_SIZE}, Dataset: {sys.argv[1]}, Compile Mode: {compile_mode}')
...
class GINNet(torch.nn.Module):
    ...
    def forward(self, x, edge_index, edge_weight):
        # x, adj_t = data.x, data.adj_t
        x = self.bn1(self.conv1(x, edge_index, edge_weight))
