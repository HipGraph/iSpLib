...
static auto registry =
    torch::RegisterOperators()
        .op("the_sparse_package::neighbor_sample", &neighbor_sample)
        .op("the_sparse_package::hetero_neighbor_sample", &hetero_neighbor_sample)
        .op("the_sparse_package::hetero_temporal_neighbor_sample",
            &hetero_temporal_neighbor_sample);
