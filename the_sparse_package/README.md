...
[testing-image]: https://github.com/rusty1s/pythe_sparse_package/actions/workflows/testing.yml/badge.svg
[testing-url]: https://github.com/rusty1s/pythe_sparse_package/actions/workflows/testing.yml
[linting-image]: https://github.com/rusty1s/pythe_sparse_package/actions/workflows/linting.yml/badge.svg
[linting-url]: https://github.com/rusty1s/pythe_sparse_package/actions/workflows/linting.yml
[coverage-image]: https://codecov.io/gh/rusty1s/pythe_sparse_package/branch/master/graph/badge.svg
[coverage-url]: https://codecov.io/github/rusty1s/pythe_sparse_package?branch=master
...
```
the_sparse_package.coalesce(index, value, m, n, op="add") -> (torch.LongTensor, torch.Tensor)
```
...
```
the_sparse_package.transpose(index, value, m, n) -> (torch.LongTensor, torch.Tensor)
```
...
```python
import torch
from the_sparse_package import transpose
...
```
the_sparse_package.spmm(index, value, m, n, matrix) -> torch.Tensor
```
...
```python
import torch
from the_sparse_package import spmm
...
```
the_sparse_package.spspmm(indexA, valueA, indexB, valueB, m, k, n) -> (torch.LongTensor, torch.Tensor)
```
