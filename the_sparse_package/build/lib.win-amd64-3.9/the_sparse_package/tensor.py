...
from the_sparse_package.storage import SparseStorage, get_layout
...
class SparseTensor(object):
    ...
    @classmethod
    def from_the_sparse_package_coo_tensor(self, mat: torch.Tensor,
                                     has_value: bool = True):
        mat = mat.coalesce()
        index = mat._indices()
    ...
    @classmethod
    def from_the_sparse_package_csr_tensor(self, mat: torch.Tensor,
                                     has_value: bool = True):
    ...
    def to_the_sparse_package_coo_tensor(
    ...
    def to_the_sparse_package_csr_tensor(
            self, dtype: Optional[int] = None) -> torch.Tensor:
