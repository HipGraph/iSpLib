...
cuda_version = torch.ops.the_sparse_package.cuda_version()
if torch.version.cuda is not None and cuda_version != -1:  # pragma: no cover
    ...
    if t_major != major:
        raise RuntimeError(
            f'Detected that PyTorch and the_sparse_package were compiled with '
            f'different CUDA versions. PyTorch has CUDA version '
            f'{t_major}.{t_minor} and the_sparse_package has CUDA version '
            f'{major}.{minor}. Please reinstall the the_sparse_package that '
...
from .convert import to_the_sparse_package, from_the_sparse_package  # noqa
...
__all__ = [
    ...
    'padded_index',
    'padded_index_select',
    'to_the_sparse_package',
    'from_the_sparse_package',
    'to_scipy',
    'from_scipy',
    'coalesce',
    'transpose',
