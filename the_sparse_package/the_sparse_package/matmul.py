...
def spmm_mean(src: SparseTensor, other: torch.Tensor) -> torch.Tensor:
    ...
    return torch.ops.the_sparse_package.spmm_mean(row, rowptr, col, value, rowcount,
...
def spmm_min(src: SparseTensor,
    ...
    return torch.ops.the_sparse_package.spmm_min(rowptr, col, value, other)
...
def spmm_max(src: SparseTensor,
    ...
    return torch.ops.the_sparse_package.spmm_max(rowptr, col, value, other)
...
def spspmm_sum(src: SparseTensor, other: SparseTensor) -> SparseTensor:
    ...
    rowptrC, colC, valueC = torch.ops.the_sparse_package.spspmm_sum(
